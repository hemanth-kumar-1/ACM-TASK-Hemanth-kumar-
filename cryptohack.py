...
print(bytes.fromhex(dec))                                    #converets hex code into bytes
...
message = binary.decode('utf-8')                #converts into ascii
print(message)
...
b= 13
for i in a:
    c = ord(i)                #converts to respective ascii value
    e = c ^ b                 #xors the value
    g = chr(e)                #converts into charecter
    print(g,end="")
# flag = crypto{aloha}
